    ...
    <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
            <div className="text-left">
                <h2 className="text-3xl font-bold text-green-400">MRL Records</h2>
                <p className="text-slate-400 mt-2">View and export all submitted MRL records.</p>
            </div>
      ...
      {records.length > 0 ? (
          ...
          {records.map(record => (
            <Card key={record.id}>
              <div className="flex flex-wrap justify-between items-start gap-4">
                <div>
                  <h3 className="text-xl font-semibold text-blue-400">Ref: {record.customerRef}</h3>
                  <p className="text-slate-300">{record.producer} - {record.variety}</p>
                  <p className="text-sm text-slate-400">Captured: {record.dateCaptured}</p>
                </div>
               ...
               {(record.customResidues && record.customResidues.length > 0) && (
                <div className="mt-4 pt-3 border-t border-slate-700">
                    <h4 className="text-sm font-semibold text-slate-300">Other Residues:</h4>
                    <ul className="text-sm text-slate-400 list-disc list-inside grid grid-cols-2 gap-x-4">
        ...
        <div className="text-center py-16">
            ...
            <h3 className="mt-4 text-xl font-semibold text-slate-300">No MRL Records Found</h3>
