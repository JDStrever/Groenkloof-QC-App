      ...
      <form onSubmit={handleSubmit}>
        <Card>
          ...
          <div className="border-b border-slate-200 pb-4 mb-6">
            <h2 className="text-3xl font-bold text-slate-800">Klas evaluering</h2>
            <p className="text-slate-500 mt-1">Class evaluation for Run: <span className="font-semibold text-orange-600">{run.runNumber}</span></p>
          </div>
          {!isReadOnly && (
                ...
                <Card key={sample.id}>
                  <div className="flex justify-between items-start mb-4 border-b border-slate-200 pb-3">
                    <h3 className="text-xl font-semibold text-slate-700">
                      Sample: <span className="text-purple-600">{sample.size} / {sample.class}</span>
                    </h3>
                    {!isReadOnly && (
