    ...
    <div className="max-w-4xl mx-auto">
      ...
      {deliveries.length > 0 ? (
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-slate-300">{delivery.farmName} ({delivery.boord}) - {delivery.variety} ({delivery.dateReceived})</p>
                  {delivery.inspectionCompletedDate && (
                    <div className="mt-2">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-900 text-green-100 border border-green-700">
        ...
        <div className="text-center py-16">
            ...
            <h3 className="mt-4 text-xl font-semibold text-slate-300">No Deliveries Found</h3>
